...
const MENU_ITEMS = [
  ...
  { text: 'Learning', to: '/learning/', activeRoutes: [] },
  { text: 'Projects', to: '/projects/', activeRoutes: [] },
        ...
        <div class="flex items-center mr-3">
          <AppLink to="/" class="flex-shrink-0 flex items-center">
            <img width="44" height="56" class="mr-4" src="/img/logo/glyph-white-colored.svg"
              alt="Rahul Aher Lightbulb" />
            <img width="107" height="40" src="/img/logo/word-white-colored.svg" alt="Rahul Aher Lightbulb" />
          </AppLink>
        </div>
