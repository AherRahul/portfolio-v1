...
<template>
  <div class="p-4 h-full w-full flex justify-center items-center" :style="bgGradientStyle">
    <div class="p-10 bg-zinc-900 h-full w-full"
      style="background-image: url(https://img.rahulaher.netlify.app/website-og/main-article.png); display: flex; flex-direction: column; justify-content: space-between;">
