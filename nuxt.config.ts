...
export default defineNuxtConfig({
  ...
  nitro: {
    ...
    prerender: {
      ...
      failOnError: false,
      ignore: [
        // Ignore missing course articles and topics that don't exist yet
        '/articles/beginner-to-advance-nodejs-5-14',
        '/articles/beginner-to-advance-nodejs-5-15',
        '/articles/beginner-to-advance-nodejs-5-16',
        '/articles/beginner-to-advance-nodejs-5-17',
        '/articles/beginner-to-advance-nodejs-5-18',
        '/articles/beginner-to-advance-nodejs-6-19',
        '/articles/beginner-to-advance-nodejs-6-20',
        '/articles/beginner-to-advance-nodejs-6-21',
        '/articles/beginner-to-advance-nodejs-6-22',
        '/articles/beginner-to-advance-nodejs-7-23',
        '/articles/beginner-to-advance-nodejs-7-24',
        '/articles/beginner-to-advance-nodejs-7-25',
        '/articles/beginner-to-advance-nodejs-8-26',
        '/articles/beginner-to-advance-nodejs-8-27',
        '/articles/beginner-to-advance-nodejs-8-28',
        '/articles/beginner-to-advance-nodejs-8-29',
        '/articles/beginner-to-advance-nodejs-9-30',
        '/articles/beginner-to-advance-nodejs-9-31',
        '/articles/beginner-to-advance-nodejs-9-32',
        '/articles/beginner-to-advance-nodejs-9-33',
        '/topics/express',
        '/topics/rest',
        '/topics/logging',
        '/topics/middleware',
