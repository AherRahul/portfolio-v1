...
function cacheKey(content, lang) {
    return (0, node_crypto_1.createHash)('md5').update(content + lang).digest('hex');
}
...
function restoreBlocks(translated, blocks) {
