...
description: "Long Polling vs WebSockets - System Design Module 12"
...
4.  Once the client receives a response—new data or a timeout—it **immediately sends a new request** to the server to keep the connection loop going.
