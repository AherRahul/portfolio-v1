...
Return _the minimum area of any rectangle formed from these points, with sides_ _**not necessarily parallel**_ _to the X and Y axes_\. If there is not any such rectangle, return `0`\.
