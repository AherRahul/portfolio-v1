...
3.  Compute the KMP table \(longest prefix that is also a suffix\) for this concatenated string\.
4.  The value at the last index of the KMP table will tell how many characters from the start of `s` form a valid palindrome\.
