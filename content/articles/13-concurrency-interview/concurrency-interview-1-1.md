---
title: "Concurrency InterviewNew"
description: "Concurrency InterviewNew - Concurrency Interview Module 1"
...
AConcurrency is about handling overlapping tasks, while parallelism is about doing tasks simultaneouslyBConcurrency is about running tasks at the same time, while parallelism is about switching between tasks quicklyCConcurrency reduces resource usage, while parallelism does notDConcurrency requires multiple CPU cores, while parallelism works even on a single core
