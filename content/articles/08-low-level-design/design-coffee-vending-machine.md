...
description: "Design a clean object model for a coffee vending machine. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class CoffeeVendingMachineSystem {
...
## Code references
- `awesome-low-level-design/problems/coffee-vending-machine.md`
