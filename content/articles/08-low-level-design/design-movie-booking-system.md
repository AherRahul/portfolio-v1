...
description: "Design a clean object model for a movie booking system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class MovieBookingSystemSystem {
...
## Code references
- `awesome-low-level-design/problems/movie-ticket-booking-system.md`
