---
title: "Decorator"
description: "Decorator is a reusable way to solve a common design problem. It gives you a proven structure so your code stays clean as it grows."
...
## Code example
```ts
interface TextView { render(): string }
class PlainText implements TextView { render() { return 'Hi'; } }
class BoldDecorator implements TextView {
  constructor(private base: TextView) {}
  render() { return '<b>' + this.base.render() + '</b>'; }
}
```
...
## Code references
- `awesome-low-level-design/design-patterns/python/decorator`
