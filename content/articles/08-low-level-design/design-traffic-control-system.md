...
description: "Design a clean object model for a traffic control system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class TrafficControlSystemSystem {
