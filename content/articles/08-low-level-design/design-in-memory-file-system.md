...
description: "Design a clean object model for a in memory file system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class InMemoryFileSystemSystem {
