...
description: "Design a clean object model for a version control system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class VersionControlSystemSystem {
