...
description: "Design a clean object model for a restaurant management system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class RestaurantManagementSystemSystem {
...
## Code references
- `awesome-low-level-design/problems/restaurant-management-system.md`
