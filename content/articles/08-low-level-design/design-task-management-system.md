...
description: "Design a clean object model for a task management system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class TaskManagementSystemSystem {
...
## Code references
- `awesome-low-level-design/problems/task-management-system.md`
