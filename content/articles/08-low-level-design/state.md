---
title: "State"
description: "State is a reusable way to solve a common design problem. It gives you a proven structure so your code stays clean as it grows."
...
## Code example
```ts
interface State { next(ctx: Player): void }
class Player {
...
## Code references
- `awesome-low-level-design/design-patterns/python/state`
