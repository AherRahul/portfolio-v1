...
description: "Design a clean object model for a notification system. Focus on responsibilities, relationships, and core flows."
...
## Class sketch
```ts
class NotificationSystemSystem {
